...
export const routes: Routes = [
  ...
  // Admin
  {
    ...
    children: [
      ...
      { path: 'orders/:id', loadComponent: () => import('./features/admin/orders/detail/admin-order-detail.component').then(m => m.AdminOrderDetailComponent) },
      { path: 'category', loadComponent: () => import('./features/admin/category/admin-category.component').then(m => m.AdminCategoryComponent) },
      { path: 'subcategory', loadComponent: () => import('./features/admin/subcategory/admin-subcategory.component').then(m => m.AdminSubcategoryComponent) },
      { path: 'transactions', loadComponent: () => import('./features/admin/transactions/admin-transactions.component').then(m => m.AdminTransactionsComponent) },
      { path: 'coupons', loadComponent: () => import('./features/admin/coupons/admin-coupons.component').then(m => m.AdminCouponsComponent) },
      { path: 'discounts', loadComponent: () => import('./features/admin/discounts/admin-discounts.component').then(m => m.AdminDiscountsComponent) },
      ...
      { path: 'ads', loadComponent: () => import('./features/admin/ads/admin-ads.component').then(m => m.AdminAdsComponent) },
